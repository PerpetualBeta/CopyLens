...
/// Diagnostic logging is gated behind the `CopyLens.debugLogging` UserDefault.
...
private let debugLoggingEnabled: Bool = {
    UserDefaults.standard.bool(forKey: "CopyLens.debugLogging")
}()

private let logFile: FileHandle? = {
    guard debugLoggingEnabled else { return nil }
    let path = "/tmp/copylens.log"
